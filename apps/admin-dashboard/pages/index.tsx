...
export default function Dashboard() {
  ...
  const [recentBookings] = useState<BookingData[]>([
    {
      id: 'RELO001',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100">Cape Town to Johannesburg route showing 23% increase in bookings. Recommend adding 2 more trucks for this high-demand corridor during weekends.</p>
              </div>
            </div>
          </div>
        </div>
